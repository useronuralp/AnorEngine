...
namespace GameEngineTest {
	namespace Graphics {
		...
		{
			bind();//THIS PART IS SO FUCKING IMPORTANT. OpenGL is a state machine and in this code snippet, before linking buffer data with a VAO, you FIRST NEED TO BIND THE VAO. Meaning you need to select the state.
