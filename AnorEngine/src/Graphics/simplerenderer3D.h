...
namespace AnorEngine {
	namespace Graphics {
		...
		public:
			...
			void singleDraw(Renderable3D& object, Shader& shader, PerspectiveCamera* camera, const int& vertexCount);

			//TO DO: implement indexed drawing.
		private:
			void updateMVP(Renderable3D& object, Shader& shader, PerspectiveCamera* camera);
		};
	}
}
